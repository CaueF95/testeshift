...
class TutsupMVC
{
	...
	public function __construct () {
		 ...
		 * controlador padrão (controllers/login-controller.php) e chama o método index().
		 */
		if ( ! $this->controlador ) {
		...
		// Inclui o arquivo do controlador
                //echo ABSPATH . '/controllers/' . $this->controlador . '.php'; die;
		...
		$this->controlador = new $this->controlador( $this->parametros );
                ...
                //var_dump($this->controlador); exit;
