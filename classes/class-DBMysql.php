...
{
	/** DB properties */
	public $host      = 'XXXXXXXXX', // Host da base de dados 
	       $db_name   = 'XXXXXXXXX', // Nome do banco de dados
	       $password  = 'XXXXXXXXX', // Senha do usuário da base de dados
	       $user      = 'XXXXXXXXX', // Usuário da base de dados
...
//        public $host      = '54.233.78.244', // Host da base de dados 
//	       $db_name   = 'municipioeletronico', // Nome do banco de dados
//	       $password  = 'm@i3l4e1c3o',          // Senha do usuário da base de dados
//	       $user      = 'meletronico',      // Usuário da base de dados
//	       $charset   = 'utf8',      // Charset da base de dados
//	       $pdo       = null,        // Nossa conexão com o BD
//	       $error     = null,        // Configura o erro
//	       $debug     = false,       // Mostra todos os erros 
