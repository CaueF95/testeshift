...
_fnCreateButton:function(a,b){
    ...
    if(-1!==this.s.dt.iTabIndex)e(c).attr("tabindex",this.s.dt.iTabIndex).attr("aria-controls",
    ...
    if(this.s.master){
        ...
        e(b.nTBody).on("click.DTTT_Select",this.s.custom.sRowSelector,function(c){
            ...
            if(d.parentNode==b.nTBody&&b.oInstance.fnGetData(d)!==null){
                if(f.type=="os")if(c.ctrlKey||c.metaKey)a.fnIsSelected(d)?a._fnRowDeselect(d,c):a._fnRowSelect(d,c);
                    else if(c.shiftKey){
                    var i=a.s.dt.aiDisplay.slice(),h=e.inArray(f.lastRow,i),o=e.inArray(j,i);
                    if(a.fnGetSelected().length===0||h===-1)i.splice(e.inArray(j,i)+1,i.length);
                    else{
                        ...
                        }else if(a.fnIsSelected(d)&&a.fnGetSelected().length===1)a._fnRowDeselect(d,c);
                    else{
                    a.fnSelectNone();
                    a._fnRowSelect(d,c)
...
_fnSelectData:function(a){
    ...
    if(a.nodeName)c=this.s.dt.oInstance.fnGetPosition(a),b.push(this.s.dt.aoData[c]);
        ...
        d=
        0;
        for(f=a.length;d<f;d++)a[d].nodeName?(c=this.s.dt.oInstance.fnGetPosition(a[d]),b.push(this.s.dt.aoData[c])):"number"===typeof a[d]?b.push(this.s.dt.aoData[a[d]]):b.push(a[d])
            }else"number"===typeof a?b.push(this.s.dt.aoData[a]):b.push(a);
    return b
    },
...
_fnColumnTargets:function(a){
    ...
    if("function"==typeof a){
        ...
        for(d=a.length;c<d;c++)b[a[c]]=!0
            }else if("visible"==a)for(c=0;c<
        d;c++)b.push(f[c].bVisible?!0:!1);
    else if("hidden"==a)for(c=0;c<d;c++)b.push(f[c].bVisible?!1:!0);
    else if("sortable"==a)for(c=0;c<d;c++)b.push(f[c].bSortable?!0:!1);else for(c=0;c<d;c++)b.push(!0);
    return b
    },
...
_fnPrintStart:function(a){
    ...
    if(""!==c.oScroll.sX||""!==c.oScroll.sY)this._fnPrintScrollStart(c),e(this.s.dt.nTable).bind("draw.DTTT_Print",function(){
    ...
    "none";e(k.body).addClass(this.classes.print.body);
...
_fnPrintEnd:function(){
    ...
    if(""!==a.oScroll.sX||""!==a.oScroll.sY)e(this.s.dt.nTable).unbind("draw.DTTT_Print"),
...
TableTools.fnGetInstance=function(a){
    ...
    for(var b=0,c=TableTools._aInstances.length;b<c;b++)if(TableTools._aInstances[b].s.master&&TableTools._aInstances[b].dom.table==a)return TableTools._aInstances[b];return null
    };
...
copy:e.extend({},TableTools.buttonBase,{
    ...
    fnComplete:function(a,b,c,
        ...
        this.fnInfo("<h6>Tabela Copiada</h6><p>"+a+" linha"+(1==a?"":"s")+" copiada"+(1==a?"":"s")+" para a área de transferência.</p>",2000)
        }
    }),
...
"function"==typeof e.fn.dataTableExt.fnVersionCheck&&e.fn.dataTableExt.fnVersionCheck("1.9.0")?e.fn.dataTableExt.aoFeatures.push({
    fnInit:function(a){
        var b=a.oInit;
...
m.fn.dataTableExt.fnVersionCheck("1.9.0")?m.fn.dataTableExt.aoFeatures.push({
    fnInit:function(a){
