...
function carregaFiltros(){
    ...
    if(tipoSelecionado == "enum"){
        ...
        if(valorEnum.length > 0){
            ...
            $.ajax({
              type : "POST",
              url : "http://192.168.0.25/portalvendasprepara/filtro/fk",
...
function salvarFiltroUsuario(){
    ...
    swal({
        ...
        $.ajax({
          ...
          type : "POST",
          url : "http://192.168.0.25/portalvendasprepara/filtro/salvar",
...
function editarFiltroUsuario(){
    ...
    swal({
        ...
        $.ajax({
          ...
          type : "POST",
          url : "http://192.168.0.25/portalvendasprepara/filtro/editar",
          data : {"idColaborador" : idColaborador
                 ,"idFiltro" : idFiltro
                 ,"filtros" : filtros},
          dataType : "json",
...
function excluirFiltroUsuario(idFiltro){
    ...
    swal({
        ...
        $.ajax({
          ...
          type : "POST",
          url : "http://192.168.0.25/portalvendasprepara/filtro/excluir",
          data : {"idColaborador" : idColaborador
                 ,"idFiltro" : idFiltro},
          dataType : "json",
          async: false,
...
function filtro(){
    ...
    $(".dataTables-example").DataTable({
        "dom": "lTfigtip",
        "tableTools": {
            "sSwfPath": "http://192.168.0.25/portalvendasprepara/views/_js/plugins/dataTables/swf/copy_csv_xls_pdf.swf"
        },
        "paging": true,
